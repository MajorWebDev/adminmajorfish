...
if(isset($_POST['add'])) {
    ...
    if(!in_array($ext,$ekstensi) ) {
        ...
        if($ukuran < 1044070){		
            ...
            mysqli_query($con, "INSERT INTO ikan (gambar, kategori, nama, deskripsi, harga, status, rating) VALUES ('$xx','$kategori','$nama','$deskripsi','$harga','$status','$rating')") or die (mysqli_error($con));
    ...
    if($filename != "") {
        ...
        if(!in_array($ext,$ekstensi) ) {
            ...
            if($ukuran < 1044070){	
                ...
                mysqli_query($con, "UPDATE ikan SET gambar = '$xx', kategori = '$kategori', nama = '$nama', deskripsi = '$deskripsi', harga = '$harga', status = '$status', rating = '$rating' WHERE id_ikan = '$id_ikan'") or die (mysqli_error($con));
        ...
        mysqli_query($con, "UPDATE ikan SET kategori = '$kategori', nama = '$nama', deskripsi = '$deskripsi', harga = '$harga', status = '$status', rating = '$rating' WHERE id_ikan = '$id_ikan'") or die (mysqli_error($con));
        header("location:edit.php?id_ikan=$id_ikan&alert=berhasil");
    }
}
?>