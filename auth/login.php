	...
	<body class="text-center">
		<form class="form-signin" action="" method="post">
			...
			if (isset($_POST['login'])) {
				...
				$sql_login = mysqli_query($con, "select * from users where username='$user' and password='$pass'") or die(mysqli_error($con));
			...
			<p class="mt-5 mb-3 text-muted">© 2021-2022 <a href="">MFishStore</a></p>
		</form>
